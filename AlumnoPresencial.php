...
class AlumnoPresencial extends Alumnos
{
    ...
    public function getNota(){
          ...
          if ((($this->inasistencias / self::$diasHabiles) * 100 ) > (100 - SELF::ASISTENCIA)) // Si asistencia < 75%, nota final sera "1"
              { $this->nota = 1;
               return $this->nota;
             }
             else { if ($suma > 0) // Si almenos la nota de un TP es menor a "4", la nota final sera "1"
              { $this->nota = 1;
               return $this->nota;
             } 
